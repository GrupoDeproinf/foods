                ...
                child: Container(
                    ...
                    child: Padding(
                        ...
                        child: SingleChildScrollView(
                          ...
                          Text(
                            "Services".tr(),
                            style: TextStyle(fontSize: 18, color: isDarkMode(context) ? Color(0xffFFFFFF) : Color(0XFF000000), fontFamily: "Oswald"),
                          ),
                          Container(
                                          ...
                                          children: [
                                            ...
                                            Container(
                                              ...
                                              child: Text(vendormodel.filters.keys.elementAt(index),
                                                      textAlign: TextAlign.center, style: TextStyle(color: isDarkMode(context) ? Colors.grey.shade300 : Color(0XFF333333), fontFamily: "Oswald"))
                                                  .tr(),
                                            ),
                                          ],
                                        ),
                          ...
                          //                             style: TextStyle(color: Color(0XFF333333), fontFamily: "Oswald"))
                          //                         .tr(),
                          //                   ),
                          //                 ],
                          //               ),
