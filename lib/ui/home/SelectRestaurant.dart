      ...
      body: Center(
        child: Padding(
          padding: const EdgeInsets.symmetric(
              vertical: 50, horizontal: kIsWeb ? 40 : 30),
          child: AspectRatio(
            aspectRatio: kIsWeb ? 3 / 4 : 3 / 5,
            child: Card(
              color: Colors.white,
              elevation: 15,
                    ...
                    child: Builder(
                      builder: ((context) {
                        if (charging) {
                          ...
                          snapshot.forEach((e) {
                            if (e.country != "" &&
                                !count.contains(_countryList
                                    .where(
                                        (f) => f["alpha_2_code"] == e.country)
                                    .first)) {
                              count.add(_countryList
                                  .where((f) => f["alpha_2_code"] == e.country)
                                  .first);
                            }
                          });
                          count.toSet().toList().sort((a, b) =>
                              (a["nameTranslations"]
                                      [context.locale.languageCode] as String)
                                  .compareTo(b["nameTranslations"]
