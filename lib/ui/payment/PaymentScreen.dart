...
import 'package:custom_food/model/PayPalCurrencyCodeErrorModel.dart'
    as payPalCurrModel;
import 'package:custom_food/model/PayStackSettingsModel.dart';
import 'package:custom_food/model/ProductModel.dart';
import 'package:custom_food/model/createRazorPayOrderModel.dart';
import 'package:custom_food/model/payStackURLModel.dart';
import 'package:custom_food/model/paypalPaymentSettle.dart' as payPalSettel;
...
import 'package:custom_food/services/rozorpayConroller.dart';
import 'package:custom_food/ui/checkoutScreen/CheckoutScreen.dart';
import 'package:custom_food/ui/wallet/PayFastScreen.dart';
import 'package:custom_food/ui/wallet/payStackScreen.dart';
...
class PaymentScreenState extends State<PaymentScreen> {
  ...
  // = UserPreference.getRazorPayData();
  ...
  @override
  void initState() {
    print(widget.vendorModel!.country);
    print(widget.deliveryCharge);
    paymentMethods.addAll(widget.payments!);
        ...
        children: [
          ListView.builder(
            ...
            itemBuilder: ((context, index) {
              var type = false;
              switch (paymentMethods[index]["name"]) {
                ...
                case "Razor Pay":
                  return Visibility(
                    visible:
                        razorPayData == null ? false : razorPayData!.isEnabled,
                    child: Column(
                      children: [
                        Divider(),
                        CheckboxListTile(
                        ...
                        CheckboxListTile(
                          ...
                          onChanged: (bool? value) {
                            setState(() {
                              ...
                              pagoMovil = true;
                              selectedCardID = '';
                              paymentOption = "Pago Móvil";
                              zelle = false;
                            });
                          },
                          value: pagoMovil,
                          contentPadding: EdgeInsets.all(0),
                          secondary: FaIcon(FontAwesomeIcons.mobileScreen),
                          title: Text('Pago Móvil'.tr()),
                        ),
                      ],
                    ),
                  );
                    ...
                    child: Column(
                      children: [
                        ...
                        CheckboxListTile(
                          ...
                          value: zelle,
                          contentPadding: EdgeInsets.all(0),
                          secondary: Image.asset("assets/images/zelle_logo.png",
                              height: 25, color: Colors.black38),
                          title: Text('Zelle'.tr()),
                        ),
                      ],
                    ),
              ...
              children: [
                ...
                ElevatedButton(
                  style: ElevatedButton.styleFrom(
                    ...
                    fixedSize: Size(MediaQuery.of(context).size.width - 40, 58),
                  ...
                  onPressed: () async {
                    ...
                    } else if (codPay || pagoMovil || zelle) {
                      paymentType = 'cod';
                      if (widget.takeAway!) {
                        placeOrder(_scaffoldKey.currentContext!);
                      } else {
  ...
  _makePaypalPayment({required amount}) async {
    PayPalClientTokenGen.paypalClientToken(
      ...
      final String tokenizationKey =
          paypalSettingData!.braintreeTokenizationKey;
  ...
  placeOrder(BuildContext buildContext, {String? oid}) async {
    ...
    OrderModel orderModel = OrderModel(
      ...
      products: tempProduc,
      status: ORDER_STATUS_CONFIRMATION_PENDING,
      vendor: vendorModel,
