...
import 'package:custom_food/model/SpecialDiscountModel.dart';
...
import 'package:custom_food/ui/vendorProductsScreen/photos.dart';
import 'package:custom_food/ui/vendorProductsScreen/services.dart';
                      ...
                      child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.center, children: [
                        Padding(
                          ...
                          child: Text(widget.vendorModel.title,
                              maxLines: 2, style: TextStyle(fontFamily: "Oswald", fontSize: 18, letterSpacing: 0.5, color: isDarkMode(context) ? Color(0xffFFFFFF) : Color(0xff2A2A2A))),
                        ),
                        resttiming()
                      ]),
                    ),
                        ...
                        children: [
                          Padding(
                            ...
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                Text("Menus", style: TextStyle(fontSize: 16, fontFamily: "Oswald")),
                                widget.vendorModel.restaurantMenuPhotos.length == 0
                                    ...
                                    : GestureDetector(
                                        ...
                                        child: Text('View All'.tr(), style: TextStyle(color: Color(COLOR_PRIMARY), fontFamily: "Oswald")),
                                      )
                              ],
                            ),
                          ),
                        ...
                        children: [
                          Padding(
                            ...
                            child: Row(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text("Cuisines", style: TextStyle(color: isDarkMode(context) ? Colors.white : Color(0xFF000000), fontSize: 16, fontFamily: "Oswald")),
                              ],
                            ),
                          ),
                          Padding(
                  ...
                  Row(
                    ...
                    children: [
                      Text(
                        ...
                        style: TextStyle(fontSize: 16, fontFamily: "Oswald", fontWeight: FontWeight.normal, letterSpacing: 0.5),
                      ),
                      Container(
                      ...
                      Text("valid till " + "Nov 31,2022", style: TextStyle(fontFamily: "Oswald", letterSpacing: 0.5))
                    ],
                  ),
                ],
              )),
