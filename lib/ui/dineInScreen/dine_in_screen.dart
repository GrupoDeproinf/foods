...
import 'package:custom_food/ui/dineInScreen/dine_in_restaurant_details_screen.dart';
      ...
      child: Container(
        ...
        child: Align(
          ...
          child: Row(
            ...
            children: [
              Text(titleValue.tr(), style: TextStyle(color: isDarkMode(context) ? Colors.white : Color(0xFF000000), fontSize: 16, fontFamily: "Oswald")),
              isViewAll!
                  ? Container()
                  : GestureDetector(
                      onTap: () {
