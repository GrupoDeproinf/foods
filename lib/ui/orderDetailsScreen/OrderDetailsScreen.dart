...
import 'package:custom_food/ui/reviewScreen.dart/reviewScreen.dart';
      ...
      body: StreamBuilder<DocumentSnapshot<Map<String, dynamic>>>(
          ...
          builder: (context, snapshot) {
            if (snapshot.hasData) {
              ...
              switch (orderStatus) {
                case ORDER_STATUS_CONFIRMATION_PENDING:
                  currentEvent =
                      'We sent your order to '.tr() + orderModel.vendor.title;
                  break;
              ...
              return SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    // Visibility(
                    //   visible:
                    //       ((orderStatus == ORDER_STATUS_CONFIRMATION_PENDING || orderStatus == ORDER_STATUS_CONFIRMED || orderStatus == ORDER_STATUS_DRIVER_PENDING || orderStatus == ORDER_STATUS_DRIVER_REJECTED) &&
                    //           !isTakeAway),
                    //   child: Card(
                    //     shape: RoundedRectangleBorder(
                    //       borderRadius: BorderRadius.circular(8.0),
                    ...
                    (orderStatus == ORDER_STATUS_CONFIRMED && isTakeAway)
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // Text(
              //   'Type'.tr(),
              //   style: TextStyle(fontSize: 16, letterSpacing: 0.5, color: isDarkMode(context) ? Colors.grey.shade200 : Color(COLOR_PRIMARY), fontFamily: "Oswald"),
              // ),
              // const SizedBox(height: 8),
              // widget.orderModel.takeAway == false
              //     ? Text(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Column(
                      ...
                      children: [
                        Row(
                          children: [
                            CachedNetworkImage(
                              ...
                              width: 55,
                              // width: 50,
                              imageUrl: getImageVAlidUrl(widget
                                          .orderModel.products[index].photo
                                          .toString()) ==
                                      placeholderImage
                                  ? ""
                                  : getImageVAlidUrl(widget
                                      .orderModel.products[index].photo
                                      .toString()),
                        ...
                        //               child: Text(
                        //                 'REORDER'.tr(),
                        //                 style: TextStyle(color: isDarkMode(context) ? const Color(0xffFFFFFF) : const Color(DARK_COLOR), fontFamily: "Oswald", fontSize: 15),
                        //               ),
                        //             )),
                        //         onTap: () async {
              ...
              Visibility(
                visible: false,
                // orderModel.vendor.specialDiscountEnable,
                child: ListTile(
                  contentPadding:
                      const EdgeInsets.symmetric(horizontal: 0, vertical: 0),
                  title: Text(
              ...
              (widget.orderModel.taxModel != null && taxAmount > 0)
                  ...
                  : Container(),
              if (widget.orderModel.vendor.country == "VE" &&
              ...
              //               style: TextStyle(color: isDarkMode(context) ? const Color(0xffFFFFFF) : Colors.white, fontFamily: "Oswald", fontSize: 15
              //                   // fontWeight: FontWeight.bold,
              //                   ),
              //             ),
              //           )),
...
//   ]);
    ...
    bytes += generator.row([
      PosColumn(
          text: widget.orderModel.taxModel!.label == null
              ? 'Tax'
              : widget.orderModel.taxModel!.label.toString(),
          width: 5,
          styles: const PosStyles(
            align: PosAlign.left,
            height: PosTextSize.size1,
  ...
  void _onMapCreated(GoogleMapController controller) {
    ...
    if (orderStatus == ORDER_STATUS_IN_TRANSIT) {
      ...
      updateCameraLocation(
          ...
          vendorLocation!,
          _mapController);
    } else if (orderStatus == ORDER_STATUS_CONFIRMED && isTakeAway) {
      updateCameraLocation(vendorLocation!, userLocation!, _mapController);
    }
  }
  ...
  getPriceTotalText(CartProduct s) {
    ...
    return Text(
      ...
      style: TextStyle(
          fontSize: 20, color: Color(COLOR_PRIMARY), fontFamily: "Oswald"),
    );
  }
