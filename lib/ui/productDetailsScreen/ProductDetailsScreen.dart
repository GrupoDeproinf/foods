...
import 'package:custom_food/services/Indicator.dart';
...
import 'package:custom_food/ui/vendorProductsScreen/review.dart';
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        //     //       ),
                        //     //       Text(
                        //     //         "${widget.productModel.reviewsCount} " + "reviews".tr(),
                        //     //         style: TextStyle(fontFamily: "Oswald", color: isDarkMode(context) ? const Color(0xffffffff) : const Color(0xff000000)),
                        //     //       ),
                        //     //     ],
                        //     //   ),
                        //     // ),
                  ...
                  //                     height: 8,
                  //                   ),
                  //                   Text("kcal".tr(), style: const TextStyle(fontSize: 16, fontFamily: "Oswald"))
                  //                 ],
                  //               ),
                  //               Column(
                  //                 children: [
                  ...
                  //                     height: 8,
                  //                   ),
                  //                   Text("grams".tr(), style: const TextStyle(fontSize: 16, fontFamily: "Oswald"))
                  //                 ],
                  //               ),
                  //               Column(
                  //                 children: [
                  ...
                  //                     height: 8,
                  //                   ),
                  //                   Text("proteins".tr(), style: const TextStyle(fontSize: 16, fontFamily: "Oswald"))
                  //                 ],
                  //               ),
                  //               Column(
                  //                 children: [
                  ...
                  //                     height: 8,
                  //                   ),
                  //                   Text("fats".tr(), style: const TextStyle(fontSize: 16, fontFamily: "Oswald"))
                  //                 ],
                  //               )
                  //             ],
                  //           ))),
                  ...
                  //                   style: TextStyle(fontFamily: "Oswald", fontSize: 16, color: isDarkMode(context) ? const Color(0xffffffff) : const Color(0xff000000)),
                  //                 ),
                  //               ),
                  //               InkWell(
                  //                 onTap: () {
                  ...
                  //                 child: Text(
                  //                   "View All".tr(),
                  //                   style: TextStyle(fontFamily: "Oswald", fontSize: 16, color: isDarkMode(context) ? const Color(0xffffffff) : Color(COLOR_PRIMARY)),
                  //                 ),
                  //               ),
                  //             ],
                  //           ),
                  ...
                  //                                             style: TextStyle(fontFamily: "Oswald", letterSpacing: 0.5, color: Color(COLOR_PRIMARY)),
                  //                                           )
                  //                                         : Column(
                  //                                             children: [
                  //                                               Text(
                  ...
                  //                                                 '$symbol${double.parse(productModel.price).toStringAsFixed(decimal)}',
                  //                                                 style: const TextStyle(
                  //                                                     fontFamily: "Oswald", fontWeight: FontWeight.bold, fontSize: 12, color: Colors.grey, decoration: TextDecoration.lineThrough),
                  //                                               ),
                  //                                             ],
                  //                                           ),
                  //                                   ],
                  ...
                  //         child: Text(
                  //           "By feature".tr(),
                  //           style: TextStyle(fontFamily: "Oswald", fontSize: 20, color: isDarkMode(context) ? const Color(0xffffffff) : const Color(0xff000000)),
                  //         ),
                  //       ),
