...
import 'package:custom_food/ui/deliveryAddressScreen/DeliveryAddressScreen.dart';
...
class _CartScreenState extends State<CartScreen> {
  ...
  Future<void> getDeliveyData() async {
    isDeliverFound = true;
    print("DEFAULT RESTAURANT ${MyAppState.currentUser!.defaultRestaurant}");
    await _fireStoreUtils
        .getVendorByVendorID(MyAppState.currentUser!.defaultRestaurant!["id"])
        .then((value) {
      vendorModel = value;
    });
    print("vendorModel es $vendorModel");
  ...
  Widget buildTotalRow(
    ...
    return Column(
      ...
      children: [
                  ...
                  children: [
                    ...
                    if (noteController.text.isNotEmpty)
                      Text(
                        "\"${noteController.text}\"",
                        style: const TextStyle(
                            fontFamily: "Oswald", color: Colors.black45),
                      ),
                  ],
                ),
                GestureDetector(
        ...
        Container(
          ...
          child: Column(
            children: [
              ...
              //                   : "(" + symbol + 0.toStringAsFixed(decimal) + ")",
              //           style: TextStyle(fontFamily: "Oswald", color: isDarkMode(context) ? const Color(0xffFFFFFF) : const Color(0xff333333), fontSize: _font),
              //         ),
              //       ],
              //     )),
              // const Divider(
              ...
              //         ? Padding(
              //             padding: const EdgeInsets.symmetric(horizontal: 20, vertical: 20),
              //             child: Text("Delivery Charge Will Applied Next Step.".tr(), style: TextStyle(fontFamily: "Oswald", fontSize: _font)),
              //           )
              //         : Container(
              //             padding: const EdgeInsets.symmetric(horizontal: 20, vertical: 20),
              //             child: Row(
        ...
        //               textAlign: TextAlign.start,
        //               style: TextStyle(fontFamily: "Oswald", fontWeight: FontWeight.bold, color: isDarkMode(context) ? const Color(0xffFFFFFF) : const Color(0xff333333), fontSize: 15),
        //             ),
        //             // Text(
        //             //   "tip-to-driver".tr(),
        //             //   style: const TextStyle(fontFamily: "Oswald", color: Color(0xff9091A4), fontSize: 14),
        //             // ),
        //             const SizedBox(
        //               height: 15,
        //             ),
        ...
        //                     decoration: BoxDecoration(
        //                       color: tipValue == 2 && isTipSelected
        //                           ? Color(COLOR_PRIMARY)
        //                           : isDarkMode(context)
        //                               ? const Color(DARK_COLOR)
        //                               : const Color(0xffFFFFFF),
        ...
        //                     child: Center(
        //                         child: Text(
        //                       symbol + double.parse("2").toStringAsFixed(decimal),
        //                       style: TextStyle(fontFamily: "Oswald", color: isDarkMode(context) ? const Color(0xffFFFFFF) : const Color(0xff333333), fontSize: 14),
        //                     )),
        //                   ),
        //                 ),
        //                 GestureDetector(
        ...
        //                     padding: const EdgeInsets.fromLTRB(15, 10, 15, 10),
        //                     decoration: BoxDecoration(
        //                       color: tipValue == 5 && isTipSelected1
        //                           ? Color(COLOR_PRIMARY)
        //                           : isDarkMode(context)
        //                               ? const Color(DARK_COLOR)
        //                               : const Color(0xffFFFFFF),
        ...
        //                     child: Center(
        //                         child: Text(
        //                       symbol + double.parse("5").toStringAsFixed(decimal),
        //                       style: TextStyle(fontFamily: "Oswald", color: isDarkMode(context) ? const Color(0xffFFFFFF) : const Color(0xff333333), fontSize: 14),
        //                     )),
        //                   ),
        //                 ),
        ...
        //                     padding: const EdgeInsets.fromLTRB(15, 10, 15, 10),
        //                     decoration: BoxDecoration(
        //                       color: tipValue == 10 && isTipSelected2
        //                           ? Color(COLOR_PRIMARY)
        //                           : isDarkMode(context)
        //                               ? const Color(DARK_COLOR)
        //                               : const Color(0xffFFFFFF),
